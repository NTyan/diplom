        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <?php if(Route::has('login')): ?>
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="<?php echo e(url('/profile')); ?>">Профиль</a>
                    </li>
    ...
    <div class="container px-5 my-5">
        <div class="row gx-5">
            <div class="col-lg-4 mb-5 mb-lg-0">
                ...
                <a class="text-decoration-none" href="<?php echo e(route('orgs')); ?>">
            ...
            <div class="col-lg-4 mb-5 mb-lg-0">
                ...
                <a class="text-decoration-none" href="<?php echo e(route('showPage')); ?>">
                    Заказать
                    <i class="bi bi-arrow-right"></i>
                </a>
            </div>
            ...
            <div class="col-lg-6 col-xl-4">
                <div class="card mb-5 mb-xl-0">
                    <div class="card-body p-5">
                        ...
                        <div class="mb-3">
                            от <span class="display-4 fw-bold"><?php echo e($PLA); ?>р.</span>
            ...
            <div class="col-lg-6 col-xl-4">
                <div class="card mb-5 mb-xl-0">
                    <div class="card-body p-5">
                        ...
                        <div class="mb-3">
                           от <span class="display-4 fw-bold"><?php echo e($ABS); ?>р.</span>
                            <span class="text-muted">/ г.</span>
                        </div>
            ...
            <div class="col-lg-6 col-xl-4">
                <div class="card">
                    <div class="card-body p-5">
                        ...
                        <div class="mb-3">
                           от <span class="display-4 fw-bold"><?php echo e($Flex); ?>р.</span>
                            <span class="text-muted">/ г.</span>
                        </div>
